...
import numpy as np
from MultiM.cvhelpers.lie.numpy import SE3
from scipy.spatial.transform import Rotation
import torch
from MultiM.utils.se3_torch import se3_inv, se3_init, se3_cat, se3_transform
...
class RigidPerturb:
    ...
    def __call__(self, data):
        ...
        if perturb_source:
            data['pose'] = se3_cat(torch.from_numpy(data['pose']), se3_inv(perturb))
