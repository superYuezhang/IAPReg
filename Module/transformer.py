...
class TransformerCrossEncoder(nn.Module):
    ...
    def __init__(self, cross_encoder_layer, num_layers, norm=None, return_intermediate=False):
        ...
        self.norm = norm
        self.return_intermediate = return_intermediate  # 返回中间层所有特征
    ...
    def forward(self, src, tgt,
        ...
        return src.permute(1, 2, 0), tgt.permute(1, 2, 0)
...
class Transformer(nn.Module):
    def __init__(self, d_model=256, nhead=4, dim_feedforward=1024, dropout=0.0):
        super().__init__()
        d_model_out = d_model
